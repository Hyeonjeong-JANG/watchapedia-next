...
export const countries: Country[] = [
  { code: 'KR', name: '대한민국' },
  { code: 'NL', name: 'NETHERLANDS ANTILLES' },
  { code: 'QC', name: 'Quebec' },
  ...
  { code: 'BH', name: '바레인' },
  { code: 'BB', name: '바베이도스' },
  { code: 'VA', name: '바티칸 시티 (Holy See)' },
  { code: 'BS', name: '바하마' },
  { code: 'BD', name: '방글라데시' },
  { code: 'BM', name: '버뮤다' },
  { code: 'VI', name: '버진 제도, 미국령' },
  { code: 'VG', name: '버진 제도, 영국령' },
  { code: 'BJ', name: '베냉' },
  { code: 'VE', name: '베네수엘라' },
  { code: 'VN', name: '베트남' },
  { code: 'BE', name: '벨기에' },
  { code: 'BY', name: '벨라루스' },
  { code: 'BZ', name: '벨리즈' },
  { code: 'BQ', name: '보네르, 신트외스타티위스, 사바 섬' },
  ...
  { code: 'SH', name: '세인트헬레나 어센션 트리스탄다쿠냐' },
  { code: 'SO', name: '소말리아' },
  { code: 'SB', name: '솔로몬 제도' },
  { code: 'SD', name: '수단' },
  { code: 'SR', name: '수리남' },
  { code: 'LK', name: '스리랑카' },
  { code: 'SJ', name: '스발바르 얀마옌 제도' },
  { code: 'SE', name: '스웨덴' },
  { code: 'CH', name: '스위스' },
  { code: 'ES', name: '스페인' },
  { code: 'SK', name: '슬로바키아' },
  { code: 'SI', name: '슬로베니아' },
  { code: 'SY', name: '시리아 아랍 공화국' },
  { code: 'SL', name: '시에라리온' },
...
export const getCountryDisplay = (code: string): string => {
  ...
  return country ? country.name : '대한민국';
};
